            ...
            with st.spinner("Running query..."):
                try:
                    ...
                    extract_task = Task(
                        ...
                        expected_output="A structured list of merchants, their associated email addresses, and image URLs (except 'Pulse id') extracted from the given text. If any of merchants or emails are unavailable, return 'errorhappened'."
                    )
