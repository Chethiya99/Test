            ...
            with st.spinner("Running query..."):
                try:
                    ...
                    extract_task = Task(
                        ...
                        expected_output="please return A structured list of merchant names, their associated email addresses (except 'Pulse id') extracted from the given text. please If any of merchant names or emails are unavailable, return 'errorhappened'."
                    )
