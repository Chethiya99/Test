        ...
        if user_query:
            with st.spinner("Running query..."):
                try:
                    ...
                    Additionally, you have the expertise to craft effective and professional emails tailored to your needs. Please always try to give answers in a table format or point wise.
                    """
